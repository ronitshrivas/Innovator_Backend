...
/// Flutter e-learning module expects (e.g. VendorName -> vendor_name). The
/// same policy is applied on the way in, so snake_case request bodies bind
/// back to their PascalCase properties.
/// </summary>
