...
namespace EventsService.Common;

/// <summary>
/// Converts property names to snake_case so responses match the shape the
/// Flutter events screen expects (e.g. CreatedByUsername -> created_by_username).
/// The same policy binds snake_case request bodies back to their properties.
/// </summary>
